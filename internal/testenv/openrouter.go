...
// Low-cost paid models that advertise text and function/tool calling support.
// The list uses established providers so fallback is not coupled to the shared
// OpenRouter free-model quota.
...
// Low-cost paid models that advertise multimodal input and function/tool
// calling support.
